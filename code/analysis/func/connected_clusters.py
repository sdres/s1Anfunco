...
nii = load('/home/sebastian/Desktop/patchFlatten/sub-02_done/upsampled/tmp/D2_bin.nii.gz')
...
data = label(data, connectivity=1)
...
outname = f'/home/sebastian/Desktop/patchFlatten/sub-02_done/upsampled/tmp/largest'
out = Nifti1Image(tmp, header=nii.header, affine=nii.affine)
save(out, outname)
...
LN2_UVD_FILTER -values largest.nii -coord_uv seg_rim_polished_UV_coordinates.nii.gz -coord_d seg_rim_polished_metric_equivol.nii.gz -domain seg_rim_polished_perimeter_chunk.nii.gz -radius 0.45 -height 2 -max
